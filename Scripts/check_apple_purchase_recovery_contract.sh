...
for source in \
    ...
    Application/Purchase/PendingApplePurchaseCoordinator.swift \
    Application/Purchase/PendingAppleTransactionRecoveryProtocol.swift \
    Application/Purchase/PurchaseSelectedProductUseCase.swift \
    Data/Purchase/PendingApplePurchaseStore.swift \
    Data/Purchase/PendingApplePurchaseStore+Diagnostics.swift \
    Data/Purchase/KeychainPurchaseDiagnosticStore.swift \
...
xcrun swiftc -parse-as-library -strict-concurrency=complete -warnings-as-errors \
    ...
    "${sources[@]}" "$module_root/Scripts/ContractProbes/ApplePurchaseRecoveryProbe.swift" \
    -o "$probe_directory/apple-purchase-recovery-probe"
"$probe_directory/apple-purchase-recovery-probe"
