...
xcrun swiftc -emit-library -emit-module -module-name BroadCore \
    ...
    "$core_root/Data/Cache/VersionedJSONCacheRepository.swift" \
    "$core_root/Infrastructure/Logging/NoOpBroadLogger.swift" \
...
for source in \
    ...
    Application/RUBilling/RUCheckoutFlowCoordinator.swift \
    ...
    Data/RUBilling/PendingRUCheckoutContext.swift \
    ...
    Infrastructure/RUBilling/SystemRUBillingDeviceContextProvider.swift; do
...
xcrun swiftc -parse-as-library -strict-concurrency=complete -warnings-as-errors \
    ...
    "$module_root/Scripts/ContractProbes/RUWaitingStoreProbe.swift" \
